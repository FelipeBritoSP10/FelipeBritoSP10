...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=flat-square&logo=instagram&logoColor=white)](https://www.instagram.com/lipe.sp.10/)
...
| Área | Escopo |
| :--- | :--- |
| ![Full Stack](https://img.shields.io/badge/Full_Stack-007ACC?style=flat-square&logo=gnubash&logoColor=white) | Aplicações Web e Mobile end-to-end, APIs REST, SQL e arquitetura escalável. |
| ![Liderança](https://img.shields.io/badge/Lideran%C3%A7a-239120?style=flat-square&logo=jira&logoColor=white) | Gestão de projetos com Scrum/Kanban e governança de código. |
| ![Mentoria](https://img.shields.io/badge/Ensino-61DAFB?style=flat-square&logo=readme&logoColor=black) | Formação técnica de devs em Lógica, Engenharia de Software, Clean Code e tecnologias Full Stack (JS, TS, React, Node, SQL). |
